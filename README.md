...
Изменения обусловлены необходимостью другой формы вывода результатов, иногда иной логикой сетевой активности.
 - добавил --show-logs, --only-logs в модуль mongodb (2020-07-08) - сама реализация работы с mongodb в zgrab2 крайне не стабильна
 - добавил single-contain, only-base64 в модуль http (2020-07-02) 
 - добавил поддержку tls соединений, вывод логов tls в модуле banner (2020-06-23)
